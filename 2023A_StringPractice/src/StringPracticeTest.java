...
class StringPracticeTest extends StringPractice {
  ...
  void testNumPunctAfterNonPunct() {
      // Test when there are no punctuation marks after non-punctuation characters
      assertEquals(0, StringPractice.numPunctAfterNonPunct("Hello World"));
      
      // Test when there is one punctuation mark after a non-punctuation character
      assertEquals(2, StringPractice.numPunctAfterNonPunct("Hello, World!"));
      
      // Test when there are multiple punctuation marks after non-punctuation characters
      assertEquals(2, StringPractice.numPunctAfterNonPunct("Hello, World!!"));
      
      // Test when there are no non-punctuation characters in the string
      assertEquals(0, StringPractice.numPunctAfterNonPunct("!!!"));
      
      // Test when there are no punctuation marks in the string
      assertEquals(0, StringPractice.numPunctAfterNonPunct("NoPunctuationHere"));
  }
}
